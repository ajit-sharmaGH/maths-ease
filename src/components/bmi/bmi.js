      ...
      <div className="pt-2">
        ...
        <div className="flex-col bmi_input_container pt-1">
          <div className="flex-wrap selection-unit">
            ...
            <select className="select-property" value={weightConvertor} onChange={e=>setWeightConvertor(e.target.value)}>
          ...
          <div className="flex-wrap selection-unit">
            ...
            <select className="select-property" value={heightConvertor} onChange={(e)=>setHeightConvertor(e.target.value)}>
        ...
        {weight.length > 0 && height.length > 0 > 0 ? (
          <div>
            ...
            <h3 className="flex-center mt-1" style={{color:color,textAlign:"center"}}> {msg} </h3>
          </div>
        ) : (
